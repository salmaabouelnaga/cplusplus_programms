...
/*QLineEdit* startFreqLE, *endFreqLE, *cycleLE, *amplitudeLE, *dcOffSetLE, *periodLE, *stepsizeLE, *samplingrateLE;
...
void MeasProtocolUI::setUp()
{
    ...
    periodLE=new QLineEdit(this);
    stepsizeLE=new QLineEdit(this);
    samplingrateLE=new QLineEdit(this);
...
void MeasProtocolUI::fillMeUp()
{
...
else
    {
       ...
       amplitudeL->setText("Amplitude");
       periodLE->setText("End Frequency");
       stepsizeLE->setText("step size");
      samplingrateLE->setText("Amplitude");
       frequencyLE->setText("frequency");
       protocolL->setText("Protocol");
       startMeas->setText("Start Measurement");
    }
}
